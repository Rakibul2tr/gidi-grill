$(document).ready(function(){
  ...
  $(window).scroll(function () {
      $('.header-bar').addClass("bg");       
    });
  


 $(".btn-close").click(function () {
        $('.notification-bar').addClass("d-none"); 
        $(".header-bar").removeClass("has-notification");       
    });


 $(".menu-wrapper .item-row").mouseover(function () {
        $(this).addClass("active");      
    });


 $(".menu-wrapper .item-row").mouseout(function () {
         $(".menu-wrapper .item-row").removeClass("active");      
    });
